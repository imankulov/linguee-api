...
download_urls = [
    ...
    get_search_url(query="einfach", src="de", dst="en", guess_direction=False),
    get_search_url(query="Tisch", src="de", dst="en", guess_direction=False),
    get_search_url(query="Möglichkei", src="de", dst="en", guess_direction=False),
